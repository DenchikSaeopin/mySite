				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="./img/<?php echo $products['img'];?>" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$<?php echo $products['price'];?> 
									<?php if($products['price_old'] != ""):?>
										<del class="product-old-price">$<?php echo $products['price_old'];?></del>
									<?php endif;?>	
								</h3>
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i>В избранное</a></li>
					...
					<div class="col-md-12">
						<div id="product-tab">
							...
							<ul class="tab-nav">
								...
								<li><a data-toggle="tab" href="#tab2">Подробнее</a></li>
